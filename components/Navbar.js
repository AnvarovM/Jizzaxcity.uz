...
const Navbar = () => {
  ...
  return (
    <div className='bg-black'>
      <div className={show ?  "px-4  md:px-0 fixed top-0 left-0 right-0 text-white my-0 py-8 transition-all duration-200": "px-4 md:px-0 bg-white bg-opacity-30 backdrop-filter backdrop-blur-lg fixed top-0 left-0 right-0 text-white my-0 py-4 transition-all duration-200"}>
