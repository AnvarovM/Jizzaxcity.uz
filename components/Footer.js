  ...
  return (
    <div className="relative">
      <img
        ...
        alt=""
      />
      <footer className="opacity-80 bg-gradient-to-r from-[#0c0c0c] to-[#130f40] py-5 z-30">
        <div className="max-w-screen-xl mx-auto px-10 lg:px-0 z-40">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
            <div>
              <h2 className="py-6 text-xl font-medium text-white uppercase">
            ...
            <div>
              <h2 className="py-6 text-xl font-medium text-white uppercase">
                {" "}
                {t("home:footer_services_heading")}{" "}
              </h2>
              <div className="space-y-2">
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <div className="p-2 rounded-md bg-gray-50 flex w-72">
                  ...
                  />
                  <button
                    className="text-sm rounded-md text-black border bg-purple-600  p-2 focus:border-none"
                    type="button"
                  >
